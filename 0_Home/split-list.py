...
def split_list(array: list):
    rounded_divider = int(len(array)/2 if len(array) % 2 == 0 else (len(array) +1)/2)

    one = array[0: rounded_divider]
    two = array[rounded_divider:len(array)]
    return [one, two]
